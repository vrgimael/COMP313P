...
(cl:in-package comp313p_planner_controller-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Goal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp313p_planner_controller-srv:<Goal-request> is deprecated: use comp313p_planner_controller-srv:Goal-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp313p_planner_controller-srv:x-val is deprecated.  Use comp313p_planner_controller-srv:x instead.")
  (x m))
...
(cl:defmethod cl:initialize-instance :after ((m <Goal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comp313p_planner_controller-srv:<Goal-response> is deprecated: use comp313p_planner_controller-srv:Goal-response instead.")))

(cl:ensure-generic-function 'reachedGoal-val :lambda-list '(m))
(cl:defmethod reachedGoal-val ((m <Goal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comp313p_planner_controller-srv:reachedGoal-val is deprecated.  Use comp313p_planner_controller-srv:reachedGoal instead.")
  (reachedGoal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Goal)))
  ...
  "comp313p_planner_controller/Goal")